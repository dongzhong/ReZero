...
#define ASSERT_NO_EXCEPTION() REZERO_CHECK(env->ExceptionCheck() == JNI_FALSE);
...
ScopedJavaLocalRef<jobjectArray> VectorToStringArray(
  ...
  REZERO_DCHECK(!string_clazz.is_null());
  jobjectArray joa =
